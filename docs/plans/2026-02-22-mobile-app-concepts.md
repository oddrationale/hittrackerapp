    ...
    >
      ...
      <header class="sticky top-0 z-30 bg-[#F7F5F0]/90 backdrop-blur-xl">
        <div class="mx-auto flex max-w-lg items-center justify-between px-5 py-3">
          <span
            class="text-[18px] tracking-[0.04em]"
      ...
      <div class="relative z-10 mx-auto max-w-lg">
        ...
        <section
          class="grid grid-cols-3 px-5 pt-5 pb-5"
        ...
        >
          {stats.map((stat, i) => (
            ...
            >
              <p
                class="text-[28px] leading-none tracking-[0.02em] tabular-nums"
                style={{ fontFamily: "'Bebas Neue', sans-serif" }}
              >
                {stat.value}
              </p>
        ...
        >
          <div class="mb-4 flex items-baseline justify-between px-5">
          ...
          <div
            class="scrollbar-none flex gap-3 overflow-x-auto px-5 pb-2"
            style={{ scrollbarWidth: "none" }}
          >
            {routines.map((routine) => (
              <button
                key={routine.name}
                class="w-[130px] flex-shrink-0 border border-[#1A1A1A]/[0.08] px-4 py-4 text-left transition-colors hover:bg-[#1A1A1A]/[0.02]"
              >
                <span
                  class="block text-[18px] leading-tight tracking-[0.02em]"
                  style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                >
                  {routine.name}
                </span>
                <span class="mt-1 block text-[10px] font-light opacity-30">
        ...
        >
          ...
          {recentWorkouts.map((w, i) => (
            <button
              key={w.name}
              class="flex w-full items-center justify-between border-b border-[#1A1A1A]/[0.08] py-3 text-left transition-colors first:border-t hover:bg-[#1A1A1A]/[0.02]"
            >
              <div>
                <span
  ...
  return (
    ...
    >
      ...
      <header class="sticky top-0 z-30 bg-[#F7F5F0]/90 backdrop-blur-xl">
        <div class="mx-auto flex max-w-lg items-center justify-between px-5 py-3">
          <span
            class="text-[22px] tracking-[0.04em]"
            style={{ fontFamily: "'Bebas Neue', sans-serif" }}
          >
            Hit Tracker
          </span>
      ...
      <div class="relative z-10 mx-auto max-w-lg">
        ...
        >
          <button class="group w-full bg-[#1A1A1A] px-5 py-10 text-center transition-all duration-200 hover:bg-[#0047FF] active:scale-[0.99]">
            <span
              class="block text-[36px] tracking-[0.03em] text-[#F7F5F0]"
              style={{ fontFamily: "'Bebas Neue', sans-serif" }}
            >
              Start Workout
            </span>
            <p
              class="mt-2 text-[14px] font-light text-[#F7F5F0]/50"
              style={{
  ...
  return (
    ...
    >
      ...
      <header class="sticky top-0 z-30 bg-[#F7F5F0]/90 backdrop-blur-xl">
        <div class="mx-auto flex max-w-lg items-center justify-between px-5 py-3">
          <span
            class="text-[24px] tracking-[0.04em]"
            style={{ fontFamily: "'Bebas Neue', sans-serif" }}
          >
            Hit Tracker
          </span>
      ...
      <div class="relative z-10 mx-auto max-w-lg">
        ...
        {/* Action card zone */}
        <section
          class="mx-5 border border-[#1A1A1A]/[0.08] px-5 pt-4 pb-5"
      ...
      <nav class="fixed right-0 bottom-0 left-0 z-40 border-t border-[#1A1A1A]/10 bg-[#F7F5F0]/90 backdrop-blur-xl">
        <div class="mx-auto grid max-w-lg grid-cols-4 py-3">
          {["Workout", "History", "Stats", "Settings"].map((label, i) => (
            ...
            >
              {i === 0 && (
                <div class="mb-1.5 h-[5px] w-[5px] rounded-full bg-[#0047FF]" />
              )}
              <span>{label}</span>
            </a>
          ))}
